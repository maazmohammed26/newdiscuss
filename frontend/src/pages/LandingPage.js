...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 discuss:bg-[#121212]">
      ...
      {/* Footer */}
      <footer className="py-6 px-4 border-t border-neutral-200 dark:border-neutral-700 discuss:border-[#333333] bg-neutral-50 dark:bg-neutral-900 discuss:bg-[#121212]">
        <div className="max-w-5xl mx-auto flex flex-col items-center gap-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 w-full">
            <DiscussLogo size="md" />
            <div className="flex items-center gap-4">
              <ThemeToggle />
              <p className="text-neutral-500 dark:text-neutral-400 discuss:text-[#9CA3AF] text-xs">&copy; {new Date().getFullYear()} Discuss. Built for developers.</p>
            </div>
          </div>
          <div className="flex flex-col items-center gap-2 pt-2 border-t border-neutral-200 dark:border-neutral-700 discuss:border-[#333333] w-full">
            <p className="text-neutral-500 dark:text-neutral-400 discuss:text-[#9CA3AF] text-[12px]">
              Developed by{' '}
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#0077B5] hover:bg-[#006399] text-white text-[11px] font-medium rounded-[6px] px-4 py-1.5 transition-colors shadow-sm"
